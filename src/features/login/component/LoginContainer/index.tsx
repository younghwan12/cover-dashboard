    ...
    try {
      ...
      if (payload.type === "accountErr") {
        ...
        modal.error({
          ...
          content: "고객지원센터 관리자(nexcore4u@sk.com, 02-6400-6123)에게 문의하세요.",
        });
        ...
        modal.error({
          ...
          content: "비밀번호 재발급 또는 고객지원센터 관리자(nexcore4u@sk.com, 02-6400-6123)에게 문의하세요.",
        });
      ...
      notification.open({
        message: "시스템 공지",
        description: "30분 뒤에 서비스 재 시작 예정입니다.",
        placement: "top",
    ...
    <div className="min-h-screen flex flex-col py-12 sm:px-6 lg:px-8">
      ...
      <div className="xl:min-w-[500px] mt-8 sm:mx-auto sm:w-full sm:max-w-md border-t-[6px] border-[#0C9BE7] drop-shadow-xl">
        <div className="bg-[#F7F7F7] py-8 px-4 shadow sm:px-10">
          <div className="pb-4 mb-2 text-2xl text-gray-700 border-b-[1px] border-[#dcdcdc]">로그인</div>
          <div className="space-y-3">
            <div>
              <label htmlFor="id" className="block mt-[10px] text-gray-700">
                사용자 ID
              </label>
              <div className="mt-1">
                <input
            ...
            <ul>
              <li className="py-[5px] text-[14px]">
                ...
                비회원 분들은 문의하기 메뉴 이용을 하실 수 없습니다.
              </li>
              <li className=" py-[5px] text-[14px]">
                <span className="text-[red] mr-1">*</span>
                비밀번호입력 오류 5회 이상 시 계정이 비활성화됩니다.
              </li>
            </ul>
          </div>
        </div>
