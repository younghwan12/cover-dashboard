                ...
                <div className="mb-12">
                    ...
                    <div className="flex justify-around items-center">
                        <div className="w-24 h-24 rounded-[50%] text-center">
                            <div className="circle bg-gray-100 text-[#ff638480] text-4xl font-extrabold">
                                {allCount?.all_cnt}
                            </div>
                            <div className="mt-3">문의사항</div>
                        </div>
                        <div className="w-24 h-24 rounded-[50%] text-center">
                            <div className="circle bg-gray-100 text-[#35a2eb80] text-4xl font-extrabold">
                                {allCount?.request_cnt}
                            </div>
                            <div className="mt-3">요청중</div>
                        </div>
                        <div className="w-24 h-24 rounded-[50%] text-center">
                            <div className="circle bg-gray-100 text-[#5f76e880] text-4xl font-extrabold">
                                {allCount?.charger_ing_cnt}
                            </div>
                            <div className="mt-3">담당자 진행중</div>
                        </div>
                        <div className="w-24 h-24 rounded-[50%] text-center">
                            <div className="circle bg-gray-50 text-[#4bc0c080] text-4xl font-extrabold">
                                {allCount?.complete_cnt}
                            </div>
