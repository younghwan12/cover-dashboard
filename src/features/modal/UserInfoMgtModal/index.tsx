...
const UserInfoMgtModal = ({ visible, setVisible, rowData }: IModalProps) => {
    ...
    useEffect(() => {
        if (profile?.userInfo) {
            console.log(profile.userInfo[0]?.auth);
            form.setFieldsValue({
                                    ...
                                    <SearchForm>
                                        ...
                                        >
                                            <Select mode="multiple">
                                                ...
                                                <Option value="alopex_grid">
                                                    Alopex Grid
                                                </Option>
                                                <Option value="alopex_dash">
                                                    Alopex Dash
                                                </Option>
                                                <Option value="alopex_runtime">
                                                    Alopex Runtime
                                                </Option>
                                                <Option value="codeinspector_nci">
                                                    NCI
                                                </Option>
                                                <Option value="testmanage_ntm">
                                                    NTM
                                                </Option>
                                                <Option value="pims_its">
                                                    ITS
                                                </Option>
                                                <Option value="pims_pms">
                                                    PMS
                                                </Option>
                                                <Option value="pims_qms">
                                                    QMS
                                                </Option>
                                                <Option value="pims_tms">
                                                    TMS
                                                </Option>
                                                <Option value="pims_agile">
                                                    AGILE
                                                </Option>
                                            </Select>
                                        </FormItem>
